...
CREATE INDEX IF NOT EXISTS matches_title_uindex ON matches (matched_title);
CREATE INDEX IF NOT EXISTS matches_url_uindex ON matches (matched_url);
CREATE INDEX IF NOT EXISTS matches_description_uindex ON matches (matched_description);
